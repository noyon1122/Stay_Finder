        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="Stay Finder" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Stay Finder</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Stay Finder</span></h2>
            ...
            <section className="service-section"><div className="service-card">
                ...
                <div className="service-card">
                    ...
                    <div className="service-details">
                        <h3 className="service-title">Mini Shop</h3>
